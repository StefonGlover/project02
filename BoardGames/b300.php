...
<body class = "questionBackground">
    ...
    <div class = "questionDiv">
        <h2> A family of two-player turn-based strategy board games played with small stones, beans, or seeds and rows of 
    ...
    <form action = "BoardGames/b300answer.php" method = "post">
